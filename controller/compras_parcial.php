 ...
 */
class compras_parcial extends fs_controller
{
   ...
   {
      parent::__construct(__CLASS__, 'Devolucion parcial', 'compras', FALSE, FALSE);
   }
   ...
   public function private_core()
   {
      ...
      if (!empty($id))
      {
         ...
         $buscar_fact = $this->factura_proveedor->get($this->factura);
      ...
      {
         $factura_original = $this->factura_proveedor->get($idfactura);
   ...
   private function crear_devolucion($fact)
   {
      ...
      if ($fact->save())
      {
         ...
         if ($asiento_factura->generar_asiento_compra($fact))
         {
